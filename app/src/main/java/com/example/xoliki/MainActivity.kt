...
open class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (flagbot==1&&shag==1) {arrXO[4]='X'
            printXO(arrXO)
            txt.text = "Поставьте O"}
        else {txt.text = "Поставьте X"}
    }
...
when (arrXO[0]){
    ...
    'X'->{bt.setImageResource(R.drawable.button_x)}
    'O'->{bt.setImageResource(R.drawable.button_o)}
    }
    when (arrXO[1]){
        ' '-> {bt2.setImageResource(R.drawable.button)}
        'X'->{bt2.setImageResource(R.drawable.button_x)}
        'O'->{bt2.setImageResource(R.drawable.button_o)}
    }
    when (arrXO[2]){
        ' '-> {bt3.setImageResource(R.drawable.button)}
        'X'->{bt3.setImageResource(R.drawable.button_x)}
        'O'->{bt3.setImageResource(R.drawable.button_o)}
    }
    when (arrXO[3]){
        ' '-> {bt4.setImageResource(R.drawable.button)}
        'X'->{bt4.setImageResource(R.drawable.button_x)}
        'O'->{bt4.setImageResource(R.drawable.button_o)}
    }
    when (arrXO[4]){
        ' '-> {bt5.setImageResource(R.drawable.button)}
        'X'->{bt5.setImageResource(R.drawable.button_x)}
        'O'->{bt5.setImageResource(R.drawable.button_o)}
    }
    when (arrXO[5]){
        ' '-> {bt6.setImageResource(R.drawable.button)}
        'X'->{bt6.setImageResource(R.drawable.button_x)}
        'O'->{bt6.setImageResource(R.drawable.button_o)}
    }
    when (arrXO[6]){
        ' '-> {bt7.setImageResource(R.drawable.button)}
        'X'->{bt7.setImageResource(R.drawable.button_x)}
        'O'->{bt7.setImageResource(R.drawable.button_o)}
    }
    when (arrXO[7]){
        ' '-> {bt8.setImageResource(R.drawable.button)}
        'X'->{bt8.setImageResource(R.drawable.button_x)}
        'O'->{bt8.setImageResource(R.drawable.button_o)}
    }
    when (arrXO[8]){
        ' '-> {bt9.setImageResource(R.drawable.button)}
        'X'->{bt9.setImageResource(R.drawable.button_x)}
        'O'->{bt9.setImageResource(R.drawable.button_o)}
    }
